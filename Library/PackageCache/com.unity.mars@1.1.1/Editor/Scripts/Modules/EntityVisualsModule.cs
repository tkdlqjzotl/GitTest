...
#pragma warning restore 649
        ...
        SlowTaskModule.SlowTask m_UpdateTask;
        SlowTaskModule.SlowTask m_RescanTask;
        ...
        void IModule.LoadModule()
        {
            ...
            m_RescanTask = new SlowTaskModule.SlowTask()
            {
                sleepTime = 0.5f,
                lastExecutionTime = 0f,
                task = ScanEntitiesAndCreateVisuals
            };

            m_UpdateTask = new SlowTaskModule.SlowTask()
            {
                sleepTime = 0.03f,
                lastExecutionTime = 0f,
                task = UpdateVisuals
            ...
            m_SlowTaskModule.AddSlowTask(m_RescanTask.task, m_RescanTask.sleepTime, true);
            m_SlowTaskModule.AddSlowTask(m_UpdateTask.task, m_UpdateTask.sleepTime, true);
        ...
        void EditorUpdateSlowTask()
        {
            ...
            m_RescanTask.Update(Time.time);
            m_UpdateTask.Update(Time.time);
        }
#endif
