...
namespace UnityEditor.MARS.Simulation
{
        ...
        IModuleMarsUpdate, IModuleBehaviorCallbacks
    {
        ...
        float m_TimeToFinalizeTimelineChange = 0.5f;
        ...
        SlowTaskModule.SlowTask m_ManualTimeChangeTask;
        ...
        void EditorUpdate()
        {
            ...
            m_ManualTimeChangeTask?.Update(Time.time);
        ...
        void OnTimeManuallyChanged(double time)
        {
            ...
            TimelineSyncState = SimulationTimeSyncState.OutOfSync;
            SyncEndTime = time;
            m_ManualTimeChangeTask = new SlowTaskModule.SlowTask
            {
                sleepTime = m_TimeToFinalizeTimelineChange,
                lastExecutionTime = Time.time,
                task = OnManualTimeChangeFinalized
            };
        }
