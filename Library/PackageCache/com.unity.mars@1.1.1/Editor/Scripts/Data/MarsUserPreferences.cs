...
namespace Unity.MARS
{
    static class MarsUserPreferences
    {
        ...
        const string k_ExtractPlanesOnSavePref = k_PrefPrefix + ".ExtractPlanesOnSave";
        ...
        static bool s_ExtractPlanesOnSave;
        ...
        public static bool ExtractPlanesOnSave
        {
            get { return s_ExtractPlanesOnSave; }
            set
            {
                s_ExtractPlanesOnSave = value;
                EditorPrefs.SetBool(k_ExtractPlanesOnSavePref, value);
            }
        }
        ...
        static MarsUserPreferences()
        {
            ...
            s_ExtractPlanesOnSave = EditorPrefs.GetBool(k_ExtractPlanesOnSavePref);
