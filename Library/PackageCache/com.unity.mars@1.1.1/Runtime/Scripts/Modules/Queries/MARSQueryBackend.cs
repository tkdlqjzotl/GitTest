...
namespace Unity.MARS.Query
{
        ...
        IUsesDatabaseQuerying
    {
        ...
        struct BufferedAction
        {
            ...
            public BufferedAction(bool isAdd, bool isGroup, QueryMatchID id) : this(isAdd)
            {
                IsAdd = isAdd;
                IsGroup = isGroup;
                QueryId = id;
            ...
            public BufferedAction(bool isAdd, QueryMatchID id, QueryArgs args) : this(isAdd)
            {
                IsAdd = isAdd;
                QueryId = id;
                SingleArgs = args;
            ...
            public BufferedAction(bool isAdd, QueryMatchID id, SetQueryArgs args) : this(isAdd)
            {
                IsAdd = isAdd;
                IsGroup = true;
                QueryId = id;
...
#pragma warning restore 67
        ...
        {
            EnqueueUpdate(new BufferedAction(false, false, queryMatchID));
        }
        ...
        {
            EnqueueUpdate(new BufferedAction(false, true, queryMatchID) {IsRemoveAll = allMatches} );
        }
        ...
        void OnStandaloneQueryTimeouts(HashSet<QueryMatchID> timeoutMatchIds)
        {
            ...
            {
                EnqueueUpdate(new BufferedAction(false, false, id) { IsTimeout = true });
            }
        }
        ...
        void OnSetTimeouts(HashSet<QueryMatchID> timeoutMatchIds)
        {
            foreach (var id in timeoutMatchIds)
            {
                EnqueueUpdate(new BufferedAction(false, true, id) {IsTimeout =  true});
            }
        }
