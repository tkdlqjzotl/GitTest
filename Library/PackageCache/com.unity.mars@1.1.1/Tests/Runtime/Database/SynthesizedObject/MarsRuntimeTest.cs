...
namespace Unity.MARS.Data.Tests
{
    ...
    abstract class MarsRuntimeTest : MonoBehaviour, IMonoBehaviourTest
    {
        ...
        protected class DummyCameraProvider : IProvidesCameraPose, IProvidesCameraOffset, IProvidesCameraProjectionMatrix
        {
...
#pragma warning restore 67
        ...
        internal MARSQueryBackend m_QueryBackend;

        protected FunctionalityInjectionModule m_FIModule;
        protected Transform m_InactiveParent;
        ...
        protected virtual void OnEnable()
        {
            ...
            var cameraProvider = new DummyCameraProvider();
